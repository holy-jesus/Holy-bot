...
<template>
    ...
    <div class="flex flex-row h-screen items-center justify-center relative z-[2]">
        ...
        <div
            ...
            <a id="loginButton"
                href="https://id.twitch.tv/oauth2/authorize?response_type=code&scope={{ scope }}&client_id=f7cx3c3iftgmukun3hkzxkdm267e4l&redirect_uri=https://holy-bot.ru/login&state={{ state }}"
                v-if="!loggedIn">
                <button
