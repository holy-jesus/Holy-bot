...
export const Moderators: React.FC = () => {
  ...
  const mods: Moderator[] = [
    { id: '1', username: 'Nightbot', addedAt: '2023-01-15', permissions: ['All'] },
    { id: '2', username: 'LoyalFan99', addedAt: '2023-03-22', permissions: ['Ban', 'Timeout'] },
    { id: '3', username: 'StreamCop', addedAt: '2023-06-10', permissions: ['All'] },
    { id: '4', username: 'PixelArtist', addedAt: '2023-08-05', permissions: ['Timeout'] },
  ];
  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          <h1 className="text-2xl font-bold text-white">{t('moderators.title')}</h1>
        ...
        <table className="w-full text-left text-sm text-slate-400">
          <thead className="bg-slate-800/50 text-slate-200 uppercase text-xs font-semibold">
            <tr>
              ...
              <th className="px-6 py-4 text-right">{t('moderators.tableActions')}</th>
            </tr>
          </thead>
                ...
                <td className="px-6 py-4">
                  <div className="flex gap-2">
                    {mod.permissions.map(perm => (
                      <span key={perm} className="px-2 py-1 rounded-md bg-slate-800 border border-slate-700 text-xs">
                        {perm}
                      </span>
                    ))}
                  </div>
